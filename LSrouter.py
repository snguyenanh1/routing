...
class LSrouter(Router):
    ...
    def handle_packet(self, port, packet):
        ...
        if packet.is_traceroute:
            ...
            if dest in self.routing_table and self.routing_table[dest] is not None:
            ...
            current_seq = -1
            if src_addr in self.ls_db:
                current_seq = self.ls_db[src_addr].get('seq_num', -1)
